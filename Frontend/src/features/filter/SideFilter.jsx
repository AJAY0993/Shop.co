...
function SideFilter() {
  ...
  return (
    <aside
      className={`b-1 fixed ${open ? "left-0" : "-left-full"} bottom-0 top-0 z-[1000000] h-full w-[19rem] border-stone-700 bg-neutral-50 px-4 pt-8 transition-all sm:absolute sm:left-0 sm:top-0 sm:bg-transparent sm:pt-2 md:pt-10 `}
    >
      <button
