...
function Hero() {
  return (
    <>
      <section className="min-h-screen  bg-[#f2f0f1] bg-right-top bg-no-repeat  md:flex md:flex-col md:bg-[url('/heroImage.png')]">
        <div className="mx:auto max-w-[77.5rem] px-4 py-2 pt-4 md:my-auto md:w-2/5 md:px-10">
          <h1 className="text-4xl font-extrabold uppercase leading-10">
            find clothes that matches your style
          </h1>
          <p className="my-4 text-xs font-medium text-stone-500">
